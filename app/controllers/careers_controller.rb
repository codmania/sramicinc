class CareersController < ApplicationController
  ...
  before_action :authenticate_admin_user!, only: [:destroy, :new, :edit, :create,:update]
  before_action :set_career, only: [:show, :edit, :update, :destroy]

  # GET /careers
  # GET /careers.json
  def index
    @careers = Career.paginate(:page => params[:page], :per_page => PER_PAGE_COUNT)
  end
  ...
  private
    ...
    def career_params
      params.require(:career).permit(:title, :description, :link)
    end
end
