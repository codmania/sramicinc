...
class CertificationsControllerTest < ActionController::TestCase
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post :create, certification: { expired: @certification.expired, institution: @certification.institution, name: @certification.name, received: @certification.received }
    end
  ...
  test "should update certification" do
    patch :update, id: @certification, certification: { expired: @certification.expired, institution: @certification.institution, name: @certification.name, received: @certification.received }
    assert_redirected_to certification_path(assigns(:certification))
  end
